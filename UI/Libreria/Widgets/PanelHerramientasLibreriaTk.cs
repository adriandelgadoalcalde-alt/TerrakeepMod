...
{
	/// <summary>
	/// El mini-panel de edicion de objeto de la Libreria: papelera + un recuadro donde ARRASTRAR
	/// un objeto real para "seleccionarlo" + editor de cantidad + editor de prefijo sobre ese
	/// mismo objeto seleccionado. Encargo explicito del usuario tras probar el mod: "el editor de
	/// stack no hay forma de usarlo comodamente ya que se selecciona pasando por encima el
	/// raton... deberiamos poder clicar/arrastrar y que quede seleccionado" + "que puedas cambiar
	/// prefijo a un arma colocandola alli... un recuadro donde puedas arrastrar el arma o el
	/// objeto y eso sera lo que este seleccionado para editar".
	/// </summary>
	/// <remarks>
	/// Vive en el hueco vacio de abajo a la derecha de <see cref="ContenidoLibreria"/> (junto a la
	...
	{
		private const float Ancho = 176f;
